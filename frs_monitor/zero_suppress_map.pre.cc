# 1 "/u/nhubbard/ucesb/eventloop/zero_suppress_map.cc"
...
# 1 "<command-line>" 2
# 1 "/u/nhubbard/ucesb/eventloop/zero_suppress_map.cc"
# 21 "/u/nhubbard/ucesb/eventloop/zero_suppress_map.cc"
...
# 22 "/u/nhubbard/ucesb/eventloop/zero_suppress_map.cc" 2



# 1 "/u/nhubbard/ucesb/eventloop/event_base.hh" 1
# 24 "/u/nhubbard/ucesb/eventloop/event_base.hh"
# 1 "gen_despec/gen/unpacker_defines.hh" 1
# 25 "/u/nhubbard/ucesb/eventloop/event_base.hh" 2

# 1 "/u/nhubbard/ucesb/file_input/hex_dump_mark.hh" 1
# 24 "/u/nhubbard/ucesb/file_input/hex_dump_mark.hh"
...
# 27 "/u/nhubbard/ucesb/eventloop/event_base.hh" 2
...
# 78 "/u/nhubbard/ucesb/eventloop/event_base.hh"
public:
  void raw_cal_user_clean();
...
# 26 "/u/nhubbard/ucesb/eventloop/zero_suppress_map.cc" 2
...
# 28 "/u/nhubbard/ucesb/eventloop/zero_suppress_map.cc" 2

struct zzp_ptr
{
public:
  zzp_ptr(void *ptr,const void *const *ptr_offset = __null)
  {
    _ptr = ptr;
      ...
      bool allow_missing)
{
  ...
  if (iter == _map_ptr_zero_suppress_info.end())
    {
      if (!allow_missing)
 do { formatted_error *__local_fe = &__fe; __local_fe->init(FE_ERROR);; __local_fe->printf("Could not find zero_suppress_info for pointer %p.",us); __local_fe->eject();; throw error(); } while (0);
      return __null;
    }
        ...
        used_zero_suppress_info &used_info)
{
  ...
  if (!known_ptr.second)
    do { formatted_error *__local_fe = &__fe; __local_fe->init(FE_ERROR);; __local_fe->printf("Ptr %p->%p already known by zero-suppression map.", p._ptr_offset,p._ptr); __local_fe->eject();; throw error(); } while (0)
                        ;



  used_info._used |= true;
}
...
zero_suppress_info_ptrs(used_zero_suppress_info &used_info)
{
  if ((used_info._info->_type & 0x07) != 0x00)
    do { formatted_error *__local_fe = &__fe; __local_fe->init(FE_ERROR);; __local_fe->printf("Two levels of zero suppression not supported!"); __local_fe->eject();; throw error(); } while (0);
# 181 "/u/nhubbard/ucesb/eventloop/zero_suppress_map.cc"
  for (int i = 0; i < n; ++i)
...
# 370 "/u/nhubbard/ucesb/eventloop/zero_suppress_map.cc"
...
void DUMMY::zero_suppress_info_ptrs(used_zero_suppress_info &__used_info)
{
  ((void)0);
  ((void)0);
}
...
void FATIMA_SCALER::zero_suppress_info_ptrs(used_zero_suppress_info &__used_info)
{
  ((void)0);

  {
  ;;
  { scalars.zero_suppress_info_ptrs(__used_info); }
  ((void)0);
  }
  ((void)0);
}
...
void FRS_FRS_SCALER::zero_suppress_info_ptrs(used_zero_suppress_info &__used_info)
{
  ((void)0);

  {
  ;;
  { scalers.zero_suppress_info_ptrs(__used_info); }
  ((void)0);
  }
  ((void)0);
}
...
void FRS_MAIN_SCALER::zero_suppress_info_ptrs(used_zero_suppress_info &__used_info)
{
  ((void)0);
...
void TRLOII_LMU_SCALERS::zero_suppress_info_ptrs(used_zero_suppress_info &__used_info)
{
  ((void)0);

  {
  ;;
  { before_lmu.zero_suppress_info_ptrs(__used_info); }
  ((void)0);
  }

  {
  ;;
  { before_lmu_mux.zero_suppress_info_ptrs(__used_info); }
  ((void)0);
  }

  {
  ;;
  { before_lmu_aux.zero_suppress_info_ptrs(__used_info); }
  ((void)0);
  }

  {
  ;;
  { before_dt.zero_suppress_info_ptrs(__used_info); }
  ((void)0);
  }

  {
  ;;
  { after_dt.zero_suppress_info_ptrs(__used_info); }
  ((void)0);
  }

  {
  ;;
  { after_reduction.zero_suppress_info_ptrs(__used_info); }
  ((void)0);
  }
...
# 160 "gen_despec/gen/struct_fcncall.hh"
  {
  ;;
  { ::zero_suppress_info_ptrs (&header.u32,__used_info); }
  ((void)0);
  }
  ((void)0);
  }
...
void TRLOII_SAMPLER::zero_suppress_info_ptrs(used_zero_suppress_info &__used_info)
{
  ((void)0);

  {
  ;;
  { sampler.zero_suppress_info_ptrs(__used_info); }
  ((void)0);
  }
...
void TRLOII_TPAT::zero_suppress_info_ptrs(used_zero_suppress_info &__used_info)
{
  ((void)0);

  {
  ;;
  { n.zero_suppress_info_ptrs(__used_info); }
  ((void)0);
  }

  {
  ;;
  { tpat.zero_suppress_info_ptrs(__used_info); }
  ((void)0);
  }

  {
  ;;
  { trig.zero_suppress_info_ptrs(__used_info); }
  ((void)0);
  }

  {
  ;;
  { ts_lo.zero_suppress_info_ptrs(__used_info); }
  ((void)0);
  }

  {
  ;;
  { ts_hi.zero_suppress_info_ptrs(__used_info); }
  ((void)0);
  }
  ((void)0);
}
...
void WHITE_RABBIT::zero_suppress_info_ptrs(used_zero_suppress_info &__used_info)
{
  ((void)0);

  {
  ;;
  { ts_id.zero_suppress_info_ptrs(__used_info); }
  ((void)0);
  }

  {
  ;;
  { ts_low.zero_suppress_info_ptrs(__used_info); }
  ((void)0);
  }

  {
  ;;
  { ts_high.zero_suppress_info_ptrs(__used_info); }
  ((void)0);
  }
  ((void)0);
}
...
void fatima_vme::zero_suppress_info_ptrs(used_zero_suppress_info &__used_info)
{
  ((void)0);
  unpack_subevent_base::zero_suppress_info_ptrs(__used_info);

  {
  ;;
  { scaler.zero_suppress_info_ptrs(__used_info); }
  ((void)0);
  }

  {
  ;;
  { dummy.zero_suppress_info_ptrs(__used_info); }
  ((void)0);
  }

  {
  ;;
  { wr.zero_suppress_info_ptrs(__used_info); }
  ((void)0);
  }
  ((void)0);
}
...
void frs_frs_subev::zero_suppress_info_ptrs(used_zero_suppress_info &__used_info)
{
  ((void)0);
  unpack_subevent_base::zero_suppress_info_ptrs(__used_info);
...
void frs_main_subev::zero_suppress_info_ptrs(used_zero_suppress_info &__used_info)
{
  ((void)0);
  unpack_subevent_base::zero_suppress_info_ptrs(__used_info);
...
void tpat_subev::zero_suppress_info_ptrs(used_zero_suppress_info &__used_info)
{
  ((void)0);
  unpack_subevent_base::zero_suppress_info_ptrs(__used_info);
...
void unpack_event::zero_suppress_info_ptrs(used_zero_suppress_info &__used_info)
{
  ((void)0);
  unpack_event_base::zero_suppress_info_ptrs(__used_info);

  {
  ;;
  { fatima.zero_suppress_info_ptrs(__used_info); }
  ((void)0);
  }

  {
  ;;
  { frs_tpat.zero_suppress_info_ptrs(__used_info); }
  ((void)0);
  }

  {
  ;;
  { frs_frs.zero_suppress_info_ptrs(__used_info); }
  ((void)0);
  }

  {
  ;;
  { frs_main.zero_suppress_info_ptrs(__used_info); }
  ((void)0);
  }
  ((void)0);
}
...
void unpack_sticky_event::zero_suppress_info_ptrs(used_zero_suppress_info &__used_info)
{
  ((void)0);
  unpack_sticky_event_base::zero_suppress_info_ptrs(__used_info);
  ((void)0);
}
...
# 371 "/u/nhubbard/ucesb/eventloop/zero_suppress_map.cc" 2
...
void raw_event::zero_suppress_info_ptrs(used_zero_suppress_info &__used_info)
{
  ((void)0);
  raw_event_base::zero_suppress_info_ptrs(__used_info);
  ((void)0);
}
...
void raw_sticky::zero_suppress_info_ptrs(used_zero_suppress_info &__used_info)
{
  ((void)0);
  raw_sticky_base::zero_suppress_info_ptrs(__used_info);
  ((void)0);
}
...
# 373 "/u/nhubbard/ucesb/eventloop/zero_suppress_map.cc" 2
...
void cal_event::zero_suppress_info_ptrs(used_zero_suppress_info &__used_info)
{
  ((void)0);
  cal_event_base::zero_suppress_info_ptrs(__used_info);
  ((void)0);
}
...
# 374 "/u/nhubbard/ucesb/eventloop/zero_suppress_map.cc" 2
# 391 "/u/nhubbard/ucesb/eventloop/zero_suppress_map.cc"
void setup_zero_suppress_info_ptrs()
{
...
void get_enum_type_name(int type,char *dest,size_t length)
{
  if (type & 0x0020) { int n = snprintf(dest,length,"has_limit "); length -= (size_t) n; dest += n; };
  if (type & 0x0040) { int n = snprintf(dest,length,"list_limit "); length -= (size_t) n; dest += n; };
  if (type & 0x0080) { int n = snprintf(dest,length,"list_limit2 "); length -= (size_t) n; dest += n; };
  if (type & 0x0100) { int n = snprintf(dest,length,"array_mask "); length -= (size_t) n; dest += n; };
  if (type & 0x0200) { int n = snprintf(dest,length,"list_index "); length -= (size_t) n; dest += n; };

  switch (type & 0x001f)
    {
    case 0x0001 : { int n = snprintf(dest,length,"float"); length -= (size_t) n; dest += n; }; break;
    case 0x0002: { int n = snprintf(dest,length,"double"); length -= (size_t) n; dest += n; }; break;
    case 0x0003: { int n = snprintf(dest,length,"ushort"); length -= (size_t) n; dest += n; }; break;
    case 0x0004 : { int n = snprintf(dest,length,"uchar"); length -= (size_t) n; dest += n; }; break;
    case 0x0005 : { int n = snprintf(dest,length,"int"); length -= (size_t) n; dest += n; }; break;
    case 0x0006 : { int n = snprintf(dest,length,"uint"); length -= (size_t) n; dest += n; }; break;
    case 0x0007 : { int n = snprintf(dest,length,"ulint"); length -= (size_t) n; dest += n; }; break;
    case 0x0008: { int n = snprintf(dest,length,"uint64"); length -= (size_t) n; dest += n; }; break;
    case 0x0009 : { int n = snprintf(dest,length,"DATA8"); length -= (size_t) n; dest += n; }; break;
    case 0x000a: { int n = snprintf(dest,length,"DATA12"); length -= (size_t) n; dest += n; }; break;
    case 0x000b: { int n = snprintf(dest,length,"DATA14"); length -= (size_t) n; dest += n; }; break;
    case 0x000c: { int n = snprintf(dest,length,"DATA16"); length -= (size_t) n; dest += n; }; break;
    case 0x0010: { int n = snprintf(dest,length,"DATA16PLUS"); length -= (size_t) n; dest += n; }; break;
    case 0x000d: { int n = snprintf(dest,length,"DATA24"); length -= (size_t) n; dest += n; }; break;
    case 0x000e: { int n = snprintf(dest,length,"DATA32"); length -= (size_t) n; dest += n; }; break;
    case 0x000f: { int n = snprintf(dest,length,"DATA64"); length -= (size_t) n; dest += n; }; break;
    default: { int n = snprintf(dest,length,"*unknown*"); length -= (size_t) n; dest += n; }; break;
    }
  ((length) ? static_cast<void> (0) : __assert_fail ("length", "/u/nhubbard/ucesb/eventloop/zero_suppress_map.cc", 443, __PRETTY_FUNCTION__));
}
